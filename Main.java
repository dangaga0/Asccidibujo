...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        switch (opcion) {
            case 1:
                dibujarCuadrado(pedirNumero(entrada, "selecciona el lado del cuadrado"));
                break;
            case 2:
                dibujarTrianguloRectangulo(pedirNumero(entrada, "selecciona la altura del triangulo"));
                break;
            case 3:
                dibujarPuntos(pedirNumero(entrada, "selleciona el valor máximo de X"), pedirNumero(entrada, "Ahora el de Y"));
                break;
